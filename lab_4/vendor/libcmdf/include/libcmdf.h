 ...
 *
 * Modified by Rull Deef, 2020:
 *      Added support for calling sub-processes with their own commands.
 * 
 * License:
 * --------
...
/* Print commands for current process */
...
void cmdf_init(const char *prompt, const char *intro, const char *doc_header,
    ...
    if (cmdf__settings_stack.size < CMDF_MAX_SUBPROCESSES) {
        ...
        exit(CMDF_ERROR_OUT_OF_PROCESS_STACK);
    }
